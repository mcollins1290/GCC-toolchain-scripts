...
- GCC: `D3A93CAD751C2AF4F8C7AD516C35B99309B5FA62`
...
```sh
cd /root/GCC-toolchain-scripts/GCC_16.1.0/aarch64/musl
```
...
```text
/opt/gcc-16.1.0-musl-cross
/opt/gcc-16.1.0-musl-cross/toolchain-manifest.txt
/opt/gcc-16.1.0-musl-cross/aarch64-linux-musl/sysroot
```
